...
public final class PassportV34 {
  static final String KIT="passport-conformance-kit-v342/ENTITY_V3_4_2_GLOBAL_PASSPORT_CLEANROOM_KIT.min.json";
  static final String KIT_SHA="ced70113f1d153627eb972b11adbf20e502ed086e0b13e8abf1dc5adc4c2e716";
  static final String EXPECTED="45af773554a7191c1b49a75c636a1106afb1de36d788bb00d7af56097b8d1b0e";
  ...
  static boolean btdu(JsonNode r){return "entity-btdu-passport-binding-v1".equals(s(r,"schema"))&&"3.4.2".equals(s(r,"btdu_version"))&&!s(r,"universe_root").isEmpty()&&!s(r,"object_ref").isEmpty()&&hex64(r.get("content_sha256"))&&!s(r,"sovereign_entity_id").isEmpty()&&b(r,"protocol_origin_is_not_asset_provenance",true)&&b(r,"topology_does_not_create_ownership",true)&&b(r,"topology_does_not_create_economic_entitlement",true)&&r.path("automatic_protocol_royalty_bps").asInt(-1)==0;}
